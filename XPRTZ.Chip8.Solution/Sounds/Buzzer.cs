namespace XPRTZ.Chip8.Solution.Sounds;
...
internal class Buzzer : ISound
{
    ...
    {
        _soundBuffer = new byte[SoundEffect.GetSampleSizeInBytes(TimeSpan.FromSeconds(0xFF / 60.0), samplesPerSecond, AudioChannels.Mono)];
